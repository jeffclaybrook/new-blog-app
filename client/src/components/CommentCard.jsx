...
const CommentCard = ({
 ...
 const LoadMoreRepliesButton = () => {
  let parentIndex = getParentIndex()
  let button =
   <button onClick={() => loadReplies({ currentIndex: parentIndex, skip: index - parentIndex })} className="text-dark-grey p-2 px-3 hover:bg-grey/30 rounded-md flex items-center gap-2">Load More</button>
