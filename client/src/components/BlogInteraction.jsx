...
const BlogInteraction = () => {
 ...
 }, [_id, access_token, setLikedByUser, username])
 ...
 return (
  <>
   ...
   <div className="flex items-center justify-between w-full p-1 px-5">
    <div className="flex gap-6">
     <div className="flex items-center gap-3">
      <button
       onClick={handleLike}
       className={`${likedByUser ? "bg-red/20 text-red " : "bg-grey/80 "} flex items-center justify-center w-10 h-10 rounded-full`}
      >
       <i className={`${likedByUser ? "fi fi-sr-heart " : "fi fi-rr-heart "} text-xl mt-2 pointer-events-none`} />
      </button>
     ...
     <div className="flex items-center gap-3">
      ...
      >
       <i className="fi fi-rr-comment-dots text-xl mt-2" />
      </button>
