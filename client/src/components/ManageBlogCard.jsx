...
export const ManageDraftBlogPost = ({ blog }) => {
 ...
 return (
  <div className="flex gap-5 lg:gap-10 pb-6 border-b mb-6 border-grey">
   <h2 className="blog-index text-center pl-4 md:pl-6 flex-none">{index < 10 ? "0" + index : index}</h2>
   <div>
 ...
 <div className="flex gap-2">
  {Object.keys(stats).map((info, i) => {
   return !info.includes("parent") && (
    <div
     key={i}
     className={"flex flex-col items-center w-full h-full justify-center p-4 px-6" + (i == 1 ? " border-grey border-r border-l " : "")}
    >
